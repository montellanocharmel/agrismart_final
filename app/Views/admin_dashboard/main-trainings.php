            ...
            <div class="modal-body">
                <form action="/addtraining" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="date" id="date" placeholder="Date of Event" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="time" class="form-label">Time</label>
                        <input type="text" name="time" id="time" placeholder="Time of Event" class="form-control">
                    </div>
                    <div class="mb-3">
