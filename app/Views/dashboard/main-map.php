                    ...
                    <div class="main_content_iner ">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="legend">
                                    <div>
                                        <h3 class="mb_25 text-center" style="color:#88c431">Legend</h3>
                                        <div class="legend-item" style="background-color: #ff7c80;">0 - 50 Hectares</div>
                                        <div class="legend-item" style="background-color: #fad05c;">51 - 100 Hectares</div>
                                        <div class="legend-item" style="background-color: #f59123;">101 - 150 Hectares</div>
                                    </div>
                                </div>
                                ...
                                <script>
                                    ...
                                    markersData.forEach(function(data) {
                                        var barangayColor = <?= json_encode($markerColors) ?>[data.barangay_name];
                                        if (!barangayColor) {
                                            barangayColor = 'rgba(0, 0, 0, 0)';
                                        }

                                        var marker = L.circleMarker([data.lat, data.lng], {
                                            radius: 10,
                                            fillColor: barangayColor,
                                            color: '#47a9ff',
                                            fillOpacity: 1,
                                            opacity: 1
                                        }).addTo(map);
                                        ...
                                        var generatePopupContent = function(data) {
                                        ...
                                        marker.on('mouseover', function(e) {
                                            var popupContent = generatePopupContent(data);
