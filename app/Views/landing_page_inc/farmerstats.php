            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                            <ul>
                                <li class="current-list-item" style="font-size: 1vw;"><a href="/">Home</a></li>

                                </li>
                                <li class="current-list-item" style="font-size: 1vw;"> <a href="/sign_ins">Login</a></li>
                                <li class="current-list-item" style="font-size: 1vw;"><a href="/registerview">Register</a></li>
                                <li class="current-list-item" style="font-size: 1vw;"><a href="/farmerstats">See Your Stats</a>
                                <li>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="table-responsive">
                                    <div class="QA_table mb-3">
                                        ...
                                        <?php else : ?>
                                            <h4 class="text-center" style="color:#88c431;" style="font-size: 1.3vw;">No crops detatils found</h4>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
